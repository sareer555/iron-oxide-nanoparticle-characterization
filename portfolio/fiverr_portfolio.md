...
- Publication-quality figures (400 dpi PNG + vector PDF, Type 42 embedded fonts)
...
| **18 figures** | 400 dpi PNG (committed) + vector PDF with embedded Type 42 fonts (regenerated by the pipeline), consistent styling |
...
| "I produce publication-quality figures" | 18 figures, 400 dpi PNG + vector PDF with embedded Type 42 fonts |
